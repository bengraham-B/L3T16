...
## How to user the App
GOOSE_RELOADED is a website which will allow users to save  data regarding their reload parameters, update their current data and delete any reloads the user no longer requires. This will thus allow users to track and improve their overall shooting preformance.
...
I was told tdeploying the app was no longer a task requirement.


___

## MongoDB
The database is GOOSE_RELOADED
